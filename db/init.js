...
function initDatabase() {
  ...
  db.exec(`
    ...
    -- Images table (for Vercel serverless - stores images in DB)
...
function seedData(db) {
  ...
  const settingsData = [
    ['site_name', 'أوتر'],
    ['site_name_en', 'Awtar'],
    ['site_description', 'أوتر - المصدر الأول للأخبار'],
    ['site_keywords', 'أوتر, أخبار, اليمن, وكالة أنباء, يمني'],
    ['site_logo', '/images/logo.png'],
    ['site_favicon', '/images/favicon.ico'],
    ['contact_email', 'info@awtar.com'],
    ['contact_phone', '+967-1-234567'],
    ['contact_address', 'صنعاء، الجمهورية اليمنية'],
    ['facebook', 'https://facebook.com/awtar'],
    ['twitter', 'https://twitter.com/awtar'],
    ['youtube', 'https://youtube.com/awtar'],
    ['telegram', 'https://t.me/awtar'],
