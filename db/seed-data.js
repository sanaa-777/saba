function seedData(db) {
  ...
  const settingsData = [
    ['site_name', 'أوتر نيوز'],
    ['site_name_en', 'Awtar News'],
    ['site_description', 'أوتر نيوز - المصدر الأول للأخبار المحلية والعربية والعالمية'],
    ['site_keywords', 'أوتر نيوز, أخبار, Yemen, وكالة أنباء, يمني, Awtar News'],
    ['site_logo', '/images/logo.png'],
    ['site_favicon', '/images/favicon.ico'],
    ['contact_email', 'info@awtarnews.com'],
    ['contact_phone', '+967-1-234567'],
    ['contact_address', 'صنعاء، الجمهورية اليمنية'],
    ['facebook', 'https://facebook.com/awtarnews'],
    ['twitter', 'https://twitter.com/awtarnews'],
    ['youtube', 'https://youtube.com/awtarnews'],
    ['telegram', 'https://t.me/awtarnews'],
